    ...
    describe('refresh', () => {
      it('should call refresh on init with configAsJson', () => {
        const configAsJson: string =
          ...
          "    status: 'Connected to data2ml Service Registry Config Server!'\n" +
          '  },\n' +
          '  jhipster: {\n' +
          '    security: {\n' +
          '      authentication: {\n' +
      ...
      it('should call refresh on init with configAsProperties', () => {
        const configAsProperties: string =
          'configserver.name: data2ml Service Registry Config Server\n' +
          'configserver.status: Connected to data2ml Service Registry Config Server!\n' +
